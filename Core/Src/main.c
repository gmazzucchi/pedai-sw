...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOB, LCD_RS_Pin|LCD_ENABLE_Pin|LCD_D0_Pin|LCD_D1_Pin
                          |LCD_D2_Pin|LCD_D3_Pin|LCD_D4_Pin|LCD_D5_Pin
                          |LCD_C3_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, LCD_D6_Pin|LCD_D7_Pin|MUX_C0_Pin|LCD_C1_Pin
                          |LCD_C2_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : LCD_RS_Pin LCD_ENABLE_Pin LCD_D0_Pin LCD_D1_Pin
                           LCD_D2_Pin LCD_D3_Pin LCD_D4_Pin LCD_D5_Pin
                           LCD_C3_Pin */
  GPIO_InitStruct.Pin = LCD_RS_Pin|LCD_ENABLE_Pin|LCD_D0_Pin|LCD_D1_Pin
                          |LCD_D2_Pin|LCD_D3_Pin|LCD_D4_Pin|LCD_D5_Pin
                          |LCD_C3_Pin;
  ...
  /*Configure GPIO pins : LCD_D6_Pin LCD_D7_Pin MUX_C0_Pin LCD_C1_Pin
                           LCD_C2_Pin */
  GPIO_InitStruct.Pin = LCD_D6_Pin|LCD_D7_Pin|MUX_C0_Pin|LCD_C1_Pin
                          |LCD_C2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
